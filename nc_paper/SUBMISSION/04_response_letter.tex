...
\textcolor{blue}{\textbf{The reviewer's interpretation is essentially the one our output supports, and we have added it:}}

\medskip

\textcolor{blue}{\textbf{\textit{``The response is not uniform around the continent. In the Ross sector the
...
sector departs from the circumpolar pattern in the variability analysis below.''}}}
...
\centering
\includegraphics[width=\textwidth]{letter_figs/figR1_wmt_domain_sensitivity.png}
\caption{\textbf{Figure R2.1} (manuscript Fig.~8). Transformation integrated south of
...
\centering
\includegraphics[width=\textwidth]{letter_figs/figR6_convection_sites.png}
\caption{\textbf{Figure R2.2} (new analysis). Where the model actually convects. (a--e) Winter
...
\caption{\textbf{Figure R2.3} (manuscript Fig.~6). Global overturning streamfunction (top) and
