...
REGIONS = {
    'Southern_Ocean': {
        ...
        'file': 'wmt_echam_heat_fesom_freshwater_southern_ocean_lgm.nc'
    },
    'Ross_Sea': {
        'title': 'Ross Sea',
        'file': 'wmt_echam_heat_fesom_freshwater_ross_sea_lgm.nc'
    },
    'Weddell_Sea': {
        'title': 'Weddell Sea',
        'file': 'wmt_echam_heat_fesom_freshwater_weddell_sea_lgm.nc'
    },
    'Adelie': {
        'title': 'Adélie Land',
        'file': 'wmt_echam_heat_fesom_freshwater_adelie_lgm.nc'
    }
}
