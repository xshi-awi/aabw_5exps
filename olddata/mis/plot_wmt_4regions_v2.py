...
REGIONS = {
    'Southern_Ocean': {
        ...
        'file': 'wmt_echam_heat_fesom_freshwater_southern_ocean_mis.nc'
    },
    'Ross_Sea': {
        'title': 'Ross Sea',
        'file': 'wmt_echam_heat_fesom_freshwater_ross_sea_mis.nc'
    },
    'Weddell_Sea': {
        'title': 'Weddell Sea',
        'file': 'wmt_echam_heat_fesom_freshwater_weddell_sea_mis.nc'
    },
    'Adelie': {
        'title': 'Adélie Land',
        'file': 'wmt_echam_heat_fesom_freshwater_adelie_mis.nc'
    }
}
