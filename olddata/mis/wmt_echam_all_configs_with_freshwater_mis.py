...
echam_file = Path('mis_echam_clim.nc')
...
mesh = xr.open_dataset("/home/a/a270064/bb1029/inputs/mesh_glac1d_38k/fesom.mesh.diag.nc")
...
for region_name, region_info in REGIONS.items():
    ...
    output_ds.attrs['experiment'] = 'MIS'

    # ========================================================================
    # 保存当前区域的结果
    # ========================================================================
    output_file = f'wmt_echam_heat_fesom_freshwater_{region_name.lower()}_mis.nc'
