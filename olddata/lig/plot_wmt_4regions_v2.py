...
REGIONS = {
    'Southern_Ocean': {
        ...
        'file': 'wmt_echam_heat_fesom_freshwater_southern_ocean_lig.nc'
    },
    'Ross_Sea': {
        'title': 'Ross Sea',
        'file': 'wmt_echam_heat_fesom_freshwater_ross_sea_lig.nc'
    },
    'Weddell_Sea': {
        'title': 'Weddell Sea',
        'file': 'wmt_echam_heat_fesom_freshwater_weddell_sea_lig.nc'
    },
    'Adelie': {
        'title': 'Adélie Land',
        'file': 'wmt_echam_heat_fesom_freshwater_adelie_lig.nc'
    }
}
